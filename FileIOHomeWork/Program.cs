...
namespace FileIOHomeWork
{
    ...
    {        
        ...
        {
            string path = @"D:\2-Обучение\Шаг\dotNET and Csharp\Модуль 16 Взаимодействие с файловой системой\";
            ...
            {
                Console.WriteLine("Sequence is not Fibanachi");
            }
            Console.ReadLine();
            ...
            path = @"D:\2-Обучение\Шаг\dotNET and Csharp\Модуль 16 Взаимодействие с файловой системой\";
